...
## Binary Tree | Binary Tree Operations | Binary Tree Properties | Binary Tree Applications | Binary Tree Visualization

### What is the binary tree ?

>A binary tree is a tree data structure in which each node has at most two children, which are referred to as the left child and the right child

<img src="https://github.com/raj-rathod/DSA-visualisation-in-angular/blob/main/src/assets/ds-image/binary-tree.jpg?raw=true">
...
## [Learn More About Binary Tree 👈](https://raj-rathod.github.io/DSA-visualisation-in-angular/)
