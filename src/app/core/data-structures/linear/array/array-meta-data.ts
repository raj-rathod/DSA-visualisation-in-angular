...
const arrayHeader = `An Array is a linear data structure that collects elements of the same data 
type and store them in <b>Contiguous and Adjacent memory location</b>. 
...
const properties: string[] = [
  ...
  `Elements of an array are stored in <b> contiguous blocks in prime memory</b>`,
  `The name of the array stored the base address of the array. 
  It acts as a pointer to the memory block where the first element has been stored`,
];
...
const applications: string[] = [
  `Arrays in data structures help to solve some high level problems like the 
  <b>Longest consecutve subsequence</b> program or some easy task like arranging the same things in ascending order`,
];
...
const disadvantage: string[] = [
  ...
  '<b> Insertion and deletion</b> operations in the array is quite tricky as the array stores elements in continuous form',
